...
public class SplashScreen implements Screen {
    ...
    public void draw(PGraphics $graphics) {
        ...
        $graphics.text("Designed by", 50, 195);
        $graphics.text("Developed by", 50, 300);
        $graphics.fill(0xFFAAAAAA);
        $graphics.text("d22", 75, 240);
        $graphics.text("d22", 75, 345);
        $graphics.text("et al.", 75, 345 + 40);
        $graphics.text("", 75, 385 + 40);
        $graphics.text("", 75, 425 + 40);
        $graphics.text("", 75, 465 + 40);
        $graphics.text("Your Name Here", 75, 505 + 40);
